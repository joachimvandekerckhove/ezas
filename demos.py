...
if __name__ == "__main__":
    ...
    parser.add_argument("--engine", choices=["pymc", "qnd"], help="Select the engine to use")
    parser.add_argument("--demo", choices=["single", "multiple", "beta_weights", "inference"], help="Select the demo to run")
